  ...
  <?php echo validation_errors(); ?>
                                   <?php  echo form_open('Product_controller/add_category_data'); ?>
                                          <div class="row">
                                              <div class="col-lg-6">
                                                  <div class="card-box">
                                                      ...
                                                      <div class="form-group m-b-20">
                                                        ...
                                                        'e.g : Apple iMac','value'=>set_value('category_name')));  ?>
                                                      ...
                                                      <?php echo form_input(array('name'=>'category_seo_name','class'=>'form-control','placeholder'=>
                                                        'e.g : Apple iMac','value'=>set_value('category_seo_name')));  ?>
                                                      </div>

                                                      
                                                      <div class="form-group m-b-20">
                                                          <label>Category Description <span class="text-danger">*</span></label>
                                                            <?php echo form_textarea(array('name'=>'category_description','class'=>'form-control','placeholder'=>'Please enter description','value'=>set_value('category_description')));  ?>
                                              ...
                                              <div class="col-lg-6">
                                                  <div class="card-box">
                                                    ...
                                                    <!--       <input type="text" name="category_meta_title" class="form-control" placeholder="Enter title" value=""> -->
                                                           <?php echo form_input(array('name'=>'category_meta_title','class'=>'form-control','placeholder'=>'Enter Meta Title','value'=>set_value('category_meta_title')));  ?>
                                                      </div>

                                                      <div class="form-group m-b-20">
                                                          <label>Meta Keywords</label>
                                                         <!--  <input type="text" name="category_meta_keyword" class="form-control" placeholder="Enter keywords" value="" > -->
                                                          <?php echo form_input(array('name'=>'category_meta_keyword','class'=>'form-control','placeholder'=>'Enter Meta Keyword','value'=>set_value('category_meta_keyword')));  ?>
                                                      </div>

                                                      <div class="form-group m-b-20">
                                                          <label>Meta Description </label>
                                                         <!--  <textarea class="form-control"  name="category_meta_description" rows="5" placeholder="Please enter description"></textarea> -->
                                                           <?php echo form_input(array('name'=>'category_meta_description','class'=>'form-control','placeholder'=>'Enter Meta description','value'=>set_value('category_meta_description')));  ?>
                                                      </div>
                                                        <div class="form-group m-b-20">
                                                          ...
                                                          <div class="radio radio-inline">
                                                              <!-- <input type="radio" value="1" name="category_status" checked=""> -->
                                                                  <?php echo form_radio('category_status' ,1,TRUE);  ?>
                                                              <label for="inlineRadio1"> Enable </label>
                                                          </div>
                                                          <div class="radio radio-inline">
                                                                <?php echo  form_radio('category_status' ,0,false); ?>
